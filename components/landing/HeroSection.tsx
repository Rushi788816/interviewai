  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#0A0F1E] px-4 sm:px-5 pb-16 pt-24 sm:pt-28 text-center">
      ...
      <div className="relative z-10 mb-7">
        ...
        >
          <span className="font-semibold text-xs sm:text-sm tracking-wide" style={{ color: '#6366F1' }}>
            🇮🇳 Made for India&apos;s job seekers
          </span>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto mb-7">
        ...
        <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-[#94A3B8]">
          Real-time AI coaching that thinks like you. Practice with Desi Mode — the only interview assistant built for Indian candidates.
        </p>
      </div>
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center gap-3 mb-14">
        <Link
          href="/signup"
          className="group px-8 sm:px-10 py-4 rounded-2xl font-bold text-white text-base sm:text-lg shadow-2xl transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_0_50px_rgba(99,102,241,0.45)] w-full sm:w-auto text-center"
          style={{
        ...
        >
          <span className="inline-flex items-center gap-2">
            Start Free — 30 Credits, No Card Needed{' '}
            <span className="group-hover:translate-x-1 transition-transform inline-block">→</span>
          </span>
        </Link>
        <Link
          href="/pricing"
          className="px-8 py-4 rounded-2xl font-semibold text-sm text-[#94A3B8] border border-white/10 hover:border-[#6366F1]/30 hover:text-white transition-all w-full sm:w-auto text-center"
        >
          See How It Works →
        </Link>
      </div>
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto">
        <div
          ...
          style={{
            ...
            boxShadow: '0 25px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(99,102,241,0.08)',
          }}
        >
          {/* Window chrome */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            >
              ...
              <p className="text-white leading-relaxed text-sm sm:text-base">
                ...
                <span className="font-mono text-[#6366F1]">scalable notification system</span>{' '}
