...
// Shared orange gradient used across the app
const ORANGE_GRADIENT = 'linear-gradient(135deg, #F7931A, #FF6B2B)'

const variantClasses: Record<string, string> = {
  default: "text-white font-semibold transition-all hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed",
  outline: "border border-white/10 text-[#94A3B8] hover:text-white hover:border-[#F7931A]/40 bg-transparent font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed",
