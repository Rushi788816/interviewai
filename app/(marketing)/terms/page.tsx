        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">1</span>
              Acceptance of Terms
            </h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">2</span>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">3</span>
              User Accounts
            </h2>
            <p className="text-[#94A3B8] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">4</span>
              Credits and Payments
            </h2>
            <p className="text-[#94A3B8] leading-relaxed mb-6">
              Credits are non-refundable and non-transferable. See our <a href="/refund" className="text-[#6366F1] hover:text-[#8B5CF6] underline">Refund Policy</a> for details.
            </p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">5</span>
              Acceptable Use
            </h2>
            <p className="text-[#94A3B8] leading-relaxed mb-6">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">6</span>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">8</span>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">9</span>
              Changes to Terms
            </h2>
            <p className="text-[#94A3B8] leading-relaxed">
          ...
          <section className="pt-12 mt-12 border-t border-[#6366F1]/20">
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#6366F1]/20 border-2 border-[#6366F1]/50 flex items-center justify-center text-sm font-bold text-[#6366F1]">10</span>
              Contact
            </h2>
